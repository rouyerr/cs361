...
if __name__ == "__main__":
    ...
    #import_studies()
    print()
    games = get_chess_com_games(username="imrosen", rated=False)
    print(f"got games {len(games)=}")
    dump_games(games, file_name= "eric_chess_non_rated")
    add_fen_list(games=games)
    dump_games(games, file_name= "eric_chess_non_rated")
    print("Done")